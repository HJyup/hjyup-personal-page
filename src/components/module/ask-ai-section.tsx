...
const AskAiSection = ({ className }: AskAiSectionProps) => {
  return (
    ...
    >
      <button
        className="ask-ai-btn bg-white text-black hover:text-blue-600 hover:bg-blue-50 transition-all px-6 py-3 rounded-lg shadow-lg hover:shadow-xl flex justify-center items-center gap-3 text-lg font-semibold group z-10 mx-auto"
        disabled
      >
