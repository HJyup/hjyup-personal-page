...
export const ProjectShare = forwardRef<HTMLDivElement, { className?: string }>(
  ({ className = '' }, ref) => {
    return (
      <WidgetLayout
        ref={ref}
        className={`flex flex-col gap-5 items-center justify-center transition-all ${className}`}
      >
        <div className="flex items-center gap-3 p-3 bg-white dark:bg-neutral-900 rounded-md w-full shadow-md">
          <div className="p-1 bg-white rounded-md">
            ...
            >
              <g clipPath="url(#clip0_69_284)">
                <g className="sc-jSgtCu bA-dyMH">
                  <path
        ...
        <div className="flex text-sm items-center italic bg-white dark:bg-neutral-900 dark:text-white rounded-md w-full shadow-md">
          <div className="bg-violet-500 w-5 h-full rounded-l-md" />
          <div className="p-3">
            "We're building a dynamic community where enthusiastic students
...
ProjectShare.displayName = 'ProjectShare';
