  ...
  return (
    <BigWidgetLayout className={className}>
      <div className="w-[90%] bg-white dark:bg-zinc-900 h-[90%] rounded-t-2xl sm:rounded-t-3xl flex flex-col relative overflow-hidden">
        <div className="bg-gray-200/30 dark:bg-zinc-800/20 w-full h-10 sm:h-12 flex px-4 sm:px-6 items-center justify-between border-b border-gray-200 dark:border-zinc-700">
        ...
        <div className="pl-3 sm:pl-4 pt-3 sm:pt-4 flex flex-col gap-2 sm:gap-3 flex-1">
          <div className="flex gap-1 items-center border-b border-gray-200 dark:border-zinc-700 pb-1 mb-2 sm:mb-3">
            <div className="text-xs sm:text-sm text-gray-500 dark:text-zinc-400 min-w-fit">
              To:
            </div>
            <div className="text-xs sm:text-sm text-gray-700 dark:text-zinc-300 border-gray-200">
          ...
          <div className="flex gap-1 items-center border-b border-gray-200 dark:border-zinc-700 pb-1 mb-2 sm:mb-3">
            ...
            <input
              ...
              className="text-xs sm:text-sm text-gray-700 dark:text-zinc-300 bg-transparent border-none outline-none flex-1 placeholder:text-gray-400 dark:placeholder:text-zinc-500"
          ...
          <div className="flex flex-col gap-1.5 sm:gap-2 flex-1">
            <textarea
              ...
              className="text-xs sm:text-sm text-gray-700 dark:text-zinc-300 bg-transparent border-none outline-none flex-1 resize-none placeholder:text-gray-400 dark:placeholder:text-zinc-500"
